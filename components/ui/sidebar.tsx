...
/** Returns a pseudo-random skeleton width between 50–90%. Called only as a useState lazy initializer. */
function randomSkeletonWidth() {
...
function SidebarMenuSkeleton({
  ...
  // Stable random width — lazy useState initializer runs once per mount.
  const [width] = React.useState(randomSkeletonWidth);
